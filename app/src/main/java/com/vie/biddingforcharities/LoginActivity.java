    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String queryStr = "?u=" + UserName + "&p=" + Password;
    ...
    public void onTaskFinish(String data) {
        try {
            ...
            if(loggedIn > 0) {
                ...
                //Store User
                ((Global) getApplication()).user = new User (user_email, user_id, user_guid, user_type, user_name_id, user_name, user_address_id, user_has_invoice);
